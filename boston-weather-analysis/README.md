...
## Description
How does the average temperature and precipitation vary in March in Boston in 2013 and 2022? This Python project addresses this research question through the analysis of the dataset, *Boston Weather 2013-2023* (Meher, 2023). This folder contains the final notebook and corresponding plots derived from this research and utilizes the Python packages `pandas`, `seaborn`, and `matplotlib`. This Python project showcases my ability to pipeline functions, clean/filter data, and create effective visualizations. 
